...
| [issue-desc-updater](plugins/kk-dev-plugin/skills/issue-desc-updater/SKILL.md) | kk-dev-plugin | 按 issue 号找到开发分支，分析实际交付内容，把 issue 正文更新为「原始需求 + 实现情况 + 与原始需求的差异」 |
| [appstore-release-notes](plugins/kk-dev-plugin/skills/appstore-release-notes/SKILL.md) | kk-dev-plugin | 对比 release 分支与 main，生成中英双语 App Store「新增内容」文案及条目溯源表 |
